...
// ─── Static Assets ──────────────────────────────────────────
const ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" role="img" aria-label="EPIC">
	<defs>
		<linearGradient id="epic-grad" x1="0" y1="0" x2="1" y2="1">
			<stop offset="0%" stop-color="#ec3065"/>
			<stop offset="100%" stop-color="#ee504e"/>
		</linearGradient>
	</defs>
	<rect x="4" y="4" width="112" height="112" rx="16" fill="#2a202b"/>
	<path d="M20 25h34v10H32v13h18v10H32v27H20z" fill="#ffffff"/>
	<rect x="58" y="25" width="42" height="60" rx="8" fill="url(#epic-grad)"/>
	<path d="M66 35h10l8 12 8-12h10L87 55l15 20H91l-10-14-10 14H60l15-20z" fill="#ffffff"/>
</svg>`;
